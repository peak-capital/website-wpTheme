 ...
 * The 'mockup' page for the new Homepage animation
 *
...
add_filter( 'body_class','fake_home_body_class' );
function fake_home_body_class( $classes ) {
        $classes[] = 'home home-intro-v2';
    return $classes;
}
